...
var umkmController_1 = require("../controllers/umkmController");
...
var lokerController_1 = require("../controllers/lokerController");
...
router.get("/umkm", umkmController_1.getUmkms);
router.get("/umkm/exclusive", umkmController_1.getUmkmExclusiveById);
router.get("/umkm/:id", umkmController_1.getUmkmById);
router.get("/umkm/category/:category", umkmController_1.getUmkmByCategory);
router.get("/umkm/top/:number", umkmController_1.getTopUmkms);
router.post("/umkm/:category", upload.fields([
    {
        name: "owner_image",
        maxCount: 1
    },
...
]), umkmController_1.postUmkmByCategory);
// router.post("/umkm/tv", upload.single("logo"), postPartnerTv);
router.post("/umkm/:id/asset", upload.single("foto"), umkmController_1.postUmkmAsset);
router.patch("/umkm/:id", upload.fields([
    {
        name: "owner_image",
        maxCount: 1
    },
...
]), umkmController_1.updateUmkmById);
router["delete"]("/umkm/:id", umkmController_1.deleteUmkmById);
router["delete"]("/umkm/asset/:id", umkmController_1.deleteUmkmAssetById);
router["delete"]("/umkm/asset/name/:name", umkmController_1.deleteUmkmAssetByName);
//visi misi
...
router.get("/comment/:umkm_id", commentController_1.getCommentByPartner);
router.get("/comment/top/:umkm_id/:number", commentController_1.getTopComments);
router.post("/comment/:umkm_id", upload.single("foto"), commentController_1.postComment);
router.get("/comment/:umkm_id/rating", commentController_1.getRatingByPartnerId);
...
// Loker
router.get("/lokers", lokerController_1.getLokers);
router.get("/loker/:id", lokerController_1.getLokerById);
router.get("/loker/admin/:admin_id", lokerController_1.getLokerByIdAdmin);
router.get("/loker/top/:number", lokerController_1.getTopLokers);
router.post("/loker", upload.single("image"), lokerController_1.postLoker);
router.patch("/loker/:id", upload.single("image"), lokerController_1.updateLokerById);
router["delete"]("/loker/:id", lokerController_1.deleteLokerById);
