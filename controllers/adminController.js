...
exports.deleteAdminById = exports.changeAdminPass = exports.authAdmin = exports.postAdminUmkm = exports.postAdmin = exports.getAdminById = exports.getAdminsUmkm = exports.getAdmins = void 0;
...
var getAdminsUmkm = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response, umkm_1, result, err_2, errMsg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 2:
                ...
                result = response.map(function (d) {
                    var id = d.id, username = d.username, password = d.password, type = d.type, umkm_id = d.umkm_id;
                    var _a = umkm_1.find(function (a) { return a.id == d.umkm_id; }), id_partner = _a.id, type_partner = _a.type, nama = _a.nama, channel = _a.channel, deskripsi = _a.deskripsi, alamat = _a.alamat, instagram = _a.instagram, facebook = _a.facebook, youtube = _a.youtube, google_maps = _a.google_maps;
                    return {
                        id: id,
                        username: username,
                        password: password,
...
exports.getAdminsUmkm = getAdminsUmkm;
...
var postAdminUmkm = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.postAdminUmkm = postAdminUmkm;
