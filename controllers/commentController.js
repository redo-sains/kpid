...
var getCommentByPartner = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var umkm_id, response, err_2, errMsg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                umkm_id = req.params.umkm_id;
                return [4 /*yield*/, commentModels_1["default"].findAll({
                        where: {
                            umkm_id: umkm_id
                        }
...
var postComment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var umkm_id, _a, nama, komen, rating, filter, final, file, response, err_3, errMsg;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                filter = JSON.parse(JSON.stringify({ nama: nama, komen: komen, rating: rating, umkm_id: umkm_id }));
                final = {};
                file = req.file;
                if (file) {
...
var getRatingByPartnerId = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var umkm_id, response, err_5, errMsg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
var getTopComments = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, number, umkm_id, response, err_6, errMsg;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.params, number = _a.number, umkm_id = _a.umkm_id;
                return [4 /*yield*/, commentModels_1["default"].findAll({
                        where: {
