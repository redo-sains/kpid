...
var getArticles = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                return [4 /*yield*/, articleModels_1["default"].findAll({ order: [["input_at", "DESC"]] })];
            case 1:
                response = _a.sent();
...
var updateArticle = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, judul, deskripsi, id, file, filter, update, final_1, response, err_6, errMsg;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                ...
                id = req.params.id;
                file = req.file;
                filter = { judul: judul, deskripsi: deskripsi };
                update = {};
                if (file) {
                    update = __assign(__assign({}, filter), { gambar: file.filename });
                }
                else {
                    update = __assign({}, filter);
                }
...
var deleteArticleById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, response, assetDelete, comment, destroy, err_8, errMsg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
