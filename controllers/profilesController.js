...
var cityModels_1 = __importDefault(require("../models/cityModels"));
var fs = require("fs");
var getProfiles = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response, value, err_1, errMsg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [4 /*yield*/, Promise.all(response.map(function (profile) { return __awaiter(void 0, void 0, void 0, function () {
                        var data, city_name;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    data = profile["dataValues"];
                                    return [4 /*yield*/, cityModels_1["default"].findOne({
                                            where: {
                                                id: profile.city_id
                                            }
                                        }).then(function (city) { return city.city_name; })];
                                case 1:
                                    city_name = _a.sent();
                                    return [2 /*return*/, __assign(__assign({}, data), { city_name: city_name })];
                            }
                        });
                    }); }))];
            case 2:
...
var getProfilesById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, response, city_name, err_2, errMsg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 2:
                city_name = _a.sent();
                res.status(200).json(__assign(__assign({}, response["dataValues"]), { city_name: city_name }));
                return [3 /*break*/, 4];
            case 3:
                err_2 = _a.sent();
                errMsg = "Gagal Untuk Melakukan Request Ini";
...
var postProfiles = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nama, jabatan, history_1, instagram, facebook, twitter, youtube, city_id, filter, final, file, response, err_3, errMsg;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, nama = _a.nama, jabatan = _a.jabatan, history_1 = _a.history, instagram = _a.instagram, facebook = _a.facebook, twitter = _a.twitter, youtube = _a.youtube, city_id = _a.city_id;
                ...
                return [4 /*yield*/, profilesModels_1["default"].create(__assign({}, final)).then(function (Lembaga) {
                        var id = Lembaga.id, history = Lembaga.history, jabatan = Lembaga.jabatan, foto = Lembaga.foto, nama = Lembaga.nama, instagram = Lembaga.instagram, facebook = Lembaga.facebook, twitter = Lembaga.twitter, youtube = Lembaga.youtube, city_id = Lembaga.city_id;
                        return {
...
var getTopProfiles = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var number, response, value, err_5, errMsg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
...
var updateProfilesById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, nama, jabatan, history_2, instagram, facebook, twitter, youtube, city_id, filter, final_1, file_1, response, err_6, errMsg;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                id = req.params.id;
                _a = req.body, nama = _a.nama, jabatan = _a.jabatan, history_2 = _a.history, instagram = _a.instagram, facebook = _a.facebook, twitter = _a.twitter, youtube = _a.youtube, city_id = _a.city_id;
                filter = JSON.parse(JSON.stringify({
                    nama: nama,
                    jabatan: jabatan,
                    history: history_2,
                ...
                return [4 /*yield*/, profilesModels_1["default"].findOne({
                        ...
                        return Profiles.update(__assign({}, final_1)).then(function (newProflies) {
                            var id = newProflies.id, history = newProflies.history, nama = newProflies.nama, jabatan = newProflies.jabatan, foto = newProflies.foto, instagram = newProflies.instagram, facebook = newProflies.facebook, twitter = newProflies.twitter, youtube = newProflies.youtube, city_id = newProflies.city_id;
                            return {
